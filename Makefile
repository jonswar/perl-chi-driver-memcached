# This Makefile is for the CHI::Driver::Memcached extension to perl.
#
...
#     ABSTRACT => q[Memcached driver for CHI]
#     AUTHOR => q[Jonathan Swartz <swartz@pobox.com>]
#     DIR => []
#     DISTNAME => q[CHI-Driver-Memcached]
#     NAME => q[CHI::Driver::Memcached]
#     NO_META => q[1]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0], Test::Class=>q[0], List::MoreUtils=>q[0.13], Moose=>q[0.33] }
#     VERSION => q[0.01]
#     dist => { PREOP=>q[$(PERL) -I. "-MModule::Install::Admin" -e "dist_preop(q($(DISTVNAME)))"] }
#     test => { TESTS=>q[t/00-load.t t/pod.t t/Sanity.t] }
...
MAKE = make
FULLEXT = CHI/Driver/Memcached
BASEEXT = Memcached
PARENT_NAME = CHI::Driver
DLBASE = $(BASEEXT)
VERSION_FROM = 
OBJECT = 
LDFROM = $(OBJECT)
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/CHI/Driver/Memcached.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/CHI/Driver
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/CHI/Driver
...
TO_INST_PM = lib/CHI/Driver/Memcached.pm \
	lib/CHI/Driver/Memcached/Test.pm \
	lib/CHI/Driver/Memcached/Test/Class.pm \
	lib/CHI/Driver/Memcached/Test/Util.pm \
	lib/CHI/Driver/Memcached/Util.pm \
	lib/CHI/Driver/Memcached/t/Sanity.pm

PM_TO_BLIB = lib/CHI/Driver/Memcached/Test/Util.pm \
	blib/lib/CHI/Driver/Memcached/Test/Util.pm \
	lib/CHI/Driver/Memcached/t/Sanity.pm \
	blib/lib/CHI/Driver/Memcached/t/Sanity.pm \
	lib/CHI/Driver/Memcached/Test.pm \
	blib/lib/CHI/Driver/Memcached/Test.pm \
	lib/CHI/Driver/Memcached/Test/Class.pm \
	blib/lib/CHI/Driver/Memcached/Test/Class.pm \
	lib/CHI/Driver/Memcached/Util.pm \
	blib/lib/CHI/Driver/Memcached/Util.pm \
	lib/CHI/Driver/Memcached.pm \
...
DISTVNAME = CHI-Driver-Memcached-0.01
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/CHI/Driver/Memcached.pm $(INST_MAN3DIR)/CHI::Driver::Memcached.$(MAN3EXT) 
...
TEST_FILE = test.pl
TEST_FILES = t/00-load.t t/pod.t t/Sanity.t
TESTDB_SW = -d
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Memcached driver for CHI</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Jonathan Swartz &lt;swartz@pobox.com&gt;</AUTHOR>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <IMPLEMENTATION>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="List-MoreUtils" VERSION="0,13,0,0" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  lib/CHI/Driver/Memcached/Test/Util.pm blib/lib/CHI/Driver/Memcached/Test/Util.pm \
	  lib/CHI/Driver/Memcached/t/Sanity.pm blib/lib/CHI/Driver/Memcached/t/Sanity.pm \
	  lib/CHI/Driver/Memcached/Test.pm blib/lib/CHI/Driver/Memcached/Test.pm \
	  lib/CHI/Driver/Memcached/Test/Class.pm blib/lib/CHI/Driver/Memcached/Test/Class.pm \
	  lib/CHI/Driver/Memcached/Util.pm blib/lib/CHI/Driver/Memcached/Util.pm \
	  lib/CHI/Driver/Memcached.pm blib/lib/CHI/Driver/Memcached.pm 
